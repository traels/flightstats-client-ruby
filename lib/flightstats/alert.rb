module FlightStats
  class Alert < Resource
    ...
    class << self
      ...
      def flight_rule_by_arrival(carrier, flight_number, arrival_airport, year, month, day, deliver_to, params = {}, options = {})
      ...
      def flight_rule_by_departure(carrier, flight_number, departure_airport, year, month, day, deliver_to, params = {}, options = {})
      ...
      def flight_rule_for_route_with_arrival_date(carrier, flight_number, departure_airport, arrival_airport, year, month, day, deliver_to, params = {}, options = {})
      ...
      def flight_rule_for_route_with_departure_date(carrier, flight_number, departure_airport, arrival_airport, year, month, day, deliver_to, params = {}, options = {})
